...
const SUPABASE_KEY = process.env.FTM_SUPABASE_SERVICE_ROLE_KEY || process.env.SUPABASE_SERVICE_ROLE_KEY;

if (!SUPABASE_URL || !SUPABASE_KEY) {
  console.error('❌ Missing FTM_SUPABASE_URL or FTM_SUPABASE_SERVICE_ROLE_KEY in ../../.env');
  process.exit(1);
}
