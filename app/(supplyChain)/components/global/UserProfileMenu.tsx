    ...
    return (
        <div className={`relative ${className || ''}`} ref={dropdownRef}>
            ...
            <button
                ...
                title={`Logged in as ${userName} (${userRole}) • Click to Change Password`}
            ...
            {isOpen && (
                <>
                    ...
                    <div 
                        ...
                        className="fixed sm:absolute inset-x-0 top-0 sm:top-full sm:right-0 sm:left-auto mt-0 sm:mt-2 w-full sm:w-[390px] h-[100dvh] sm:h-auto sm:max-h-[620px] 
                        bg-white dark:bg-[#1c1d25] 
                        ...
                        <div className="flex items-center justify-between px-4 py-3.5 
                            ...
                            <button
                                ...
                                className="p-1.5 text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700/50 rounded-lg transition-colors cursor-pointer disabled:opacity-50"
                                aria-label="Close"
                            >
                                <X className="h-4 w-4" />
                            </button>
                                ...
                                <div className="text-center py-4 space-y-4">
                                    ...
                                    <div className="pt-2 flex flex-col sm:flex-row gap-2 justify-center">
                                        <button
                                            ...
                                            className="px-3.5 py-2 bg-rose-50 dark:bg-rose-950/30 text-rose-600 dark:text-rose-400 border border-rose-200 dark:border-rose-900/40 rounded-xl text-xs font-semibold hover:bg-rose-100 dark:hover:bg-rose-950/60 transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                                        >
                                        ...
                                        <button
                                            type="button"
                                            onClick={handleClose}
                                            className="px-4 py-2 bg-pink-600 hover:bg-pink-700 text-white rounded-xl text-xs font-semibold transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-xs"
                                        >
                                ...
                                <>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                disabled={isSubmitting}
                                                className="w-full pl-9 pr-9 py-2 text-xs bg-white dark:bg-[#2a2a2e] border border-slate-200/90 dark:border-slate-700/60 rounded-xl text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:ring-2 focus:ring-pink-500 outline-none transition"
                                                autoFocus
                                            />
                                            <button
                                                type="button"
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                disabled={isSubmitting}
                                                className={`w-full pl-9 pr-9 py-2 text-xs bg-white dark:bg-[#2a2a2e] border rounded-xl text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:ring-2 focus:ring-pink-500 outline-none transition ${
                                    ...
                                    <div className="pt-2 flex items-center justify-between gap-2">
                                        <button
                                            ...
                                            onClick={handleClose}
                                            disabled={isSubmitting}
                                            className="px-3 py-2 text-xs font-semibold text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white border border-slate-200 dark:border-slate-700/80 rounded-xl bg-white dark:bg-[#2a2a2e] hover:bg-slate-50 dark:hover:bg-slate-800 transition disabled:opacity-50 cursor-pointer"
                                        >
                                            Cancel
                                        </button>
                                        ...
                                        <div className="flex items-center gap-2">
                                            <button
                                                ...
                                                className="px-3 py-2 text-xs font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700/50 border border-slate-200 dark:border-slate-700/80 rounded-xl bg-white dark:bg-[#2a2a2e] transition disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-1 cursor-pointer"
                                            ...
                                            <button
                                                ...
                                                disabled={isSubmitting || !isAllCriteriaMet}
                                                className="px-3.5 py-2 bg-pink-600 hover:bg-pink-700 text-white rounded-xl text-xs font-semibold transition shadow-xs active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-1.5 cursor-pointer"
