...
export function ChartDetailModal({ isOpen, onClose, month, monthIndex, orders, totalAmount, }: ChartDetailModalProps) {
    if (!isOpen)
        return null;
    return (
        <Portal>
            ...
            <div className="bg-[#f0f3f8] dark:bg-[#161722] rounded-3xl  dark:shadow-[14px_14px_40px_rgba(0,0,0,0.8),-4px_-4px_12px_rgba(255,255,255,0.03)] w-full max-w-2xl max-h-[90vh] flex flex-col border border-white/90 dark:border-white/[0.08] overflow-hidden animate-in zoom-in-95 duration-200" onClick={(e) => e.stopPropagation()}>
                <div className="px-6 py-4.5 border-b border-slate-200/60 dark:border-white/[0.06] flex items-center justify-between">
                    <div>
                ...
                <div className="p-6 overflow-y-auto space-y-4">
                    {orders.length === 0 ? (<div className="flex flex-col items-center justify-center py-12 text-slate-400 dark:text-slate-500">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                <div className="p-3 rounded-2xl bg-[#ebf0f7] dark:bg-[#14151e] border border-white/80 dark:border-white/[0.06] shadow-[inset_1.5px_1.5px_3px_rgba(166,175,195,0.35),inset_-1.5px_-1.5px_3px_rgba(255,255,255,0.9)] dark:shadow-[inset_1.5px_1.5px_3px_rgba(0,0,0,0.6)] text-center">
                            ...
                            <div>
                                ...
                                <div className="space-y-2 max-h-[300px] overflow-y-auto pr-1">
                                    {orders.map((order) => (<div key={order.id} className="flex items-center justify-between p-3 rounded-2xl bg-[#ebf0f7] dark:bg-[#14151e] border border-slate-200/60 dark:border-white/[0.06] shadow-[inset_1.5px_1.5px_3px_rgba(166,175,195,0.25)] transition-all">
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {order.paid && (<span className="inline-flex items-center px-1.5 py-0.3 rounded text-[10px] font-medium bg-emerald-50 dark:bg-emerald-950/40 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800/30">
                                                            Paid
                                                        </span>)}
                                                </div>
                ...
                <div className="px-6 py-4 border-t border-slate-200/60 dark:border-white/[0.06] flex justify-end">
