                    ...
                    <div className="flex items-center gap-2">
                        {verificationState === 'verifying' && (
                            <button
                                type="button"
                                onClick={onClose}
                                className="px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs font-semibold flex items-center gap-1.5 transition-all cursor-pointer"
                        ...
                        <button
                            type="button"
                            onClick={onClose}
                            className="w-8 h-8 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800/80 text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 transition-all flex items-center justify-center cursor-pointer"
                        >
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-end gap-2.5 pt-2">
                                ...
                                <button
                                    type="button"
                                    onClick={onClose}
                                    className="px-5 py-2 text-xs font-bold bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 rounded-xl transition-all cursor-pointer"
                                >
                                    Done
                                </button>
                            </div>
