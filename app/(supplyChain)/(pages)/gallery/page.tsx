...
import { Search, Grid, List, Calendar, User, Tag, Eye, X, Download, Image as ImageIcon, HardDrive, Filter, XCircle, Loader2, ZoomIn, ZoomOut, RotateCw, RotateCcw, Maximize2, ChevronLeft, ChevronRight, Check, RefreshCw } from 'lucide-react';
...
const GalleryCard = memo(function GalleryCard({ item, hasError, onPreview, onDownload, onRetry, onImageError }: GalleryCardProps) {
...
export default function MediaGallery() {
    ...
    useEffect(() => {
        ...
        if (!el || !selectedTypeInfo?.isImage || !isPreviewOpen)
            return;
