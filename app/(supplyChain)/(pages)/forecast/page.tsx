    ...
    return (<SessionGuard requiredRole={['Admin', 'Employee', 'Executive']}>
                    ...
                    <div className="p-5 sm:p-6 rounded-3xl bg-[#f0f3f8] dark:bg-[#191a24] border border-white/80 dark:border-[#2c2d3c] shadow-[8px_8px_24px_rgba(166,175,195,0.4),-8px_-8px_24px_rgba(255,255,255,0.95),inset_0_1px_1.5px_rgba(255,255,255,0.9)] dark:shadow-[10px_10px_30px_rgba(0,0,0,0.75),-6px_-6px_20px_rgba(255,255,255,0.03),inset_0_1px_1px_rgba(255,255,255,0.07)] relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 mt-2">
                            {aiSummary.split('\n\n').filter(Boolean).map((section, idx) => {
                                ...
                                return (
                                    <div key={idx} className="p-3.5 rounded-2xl bg-[#ebf0f7] dark:bg-[#14151c] border border-slate-200/60 dark:border-slate-800 shadow-[inset_1.5px_1.5px_3px_rgba(166,175,195,0.25)] whitespace-pre-line text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
                                        {section}
                                    </div>
                                );
                            })}
            ...
            title: '7-Day Parcel Volume Forecast Analysis',
                    ...
                    <div className="mt-4 relative h-80 w-full cursor-pointer">
                        {loading && (<div className="absolute inset-0 flex items-center justify-center bg-[#f0f3f8]/70 dark:bg-[#191a24]/70 z-10">
                                <i className="fas fa-circle-notch fa-spin text-pink-500 text-2xl"></i>
                            </div>)}

                        {!loading && !hasParcelData && (<div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 bg-[#ebf0f7] dark:bg-[#14151c] rounded-2xl border border-slate-200/60 dark:border-slate-800 shadow-[inset_2px_2px_5px_rgba(166,175,195,0.35),inset_-2px_-2px_5px_rgba(255,255,255,0.9)] dark:shadow-[inset_2px_2px_6px_rgba(0,0,0,0.65)]">
                                <div className="w-14 h-14 rounded-3xl bg-[#f0f3f8] dark:bg-[#191a24] border border-white/80 dark:border-[#2c2d3c] shadow-[4px_4px_12px_rgba(166,175,195,0.4),-4px_-4px_12px_rgba(255,255,255,0.95)] text-pink-500 dark:text-pink-400 flex items-center justify-center text-xl mb-2.5">
                                    <i className="fas fa-chart-line"></i>
                                </div>
                                <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200">No Parcel Data</h3>
                    ...
                    <div className="mt-3 p-3 rounded-2xl bg-[#ebf0f7] dark:bg-[#14151c] border border-slate-200/60 dark:border-slate-800 shadow-[inset_1.5px_1.5px_3px_rgba(166,175,195,0.25)] text-xs text-slate-600 dark:text-slate-300 flex items-center justify-between flex-wrap gap-2">
                        <div>
                        ...
                        <span className="text-[11px] text-pink-600 dark:text-pink-400 font-bold cursor-pointer" onClick={() => setActiveChartModal({ isOpen: true, type: 'parcels', title: '7-Day Parcel Volume Forecast Analysis' })}>
            ...
            title: 'Procurement Outlay & Budget Projections',
                            ...
                            <div className="mt-4 relative h-70 w-full cursor-pointer">
                                ...
                                {!loading && !hasExpenseData && (<div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 bg-[#ebf0f7] dark:bg-[#14151c] rounded-2xl border border-slate-200/60 dark:border-slate-800 shadow-[inset_2px_2px_5px_rgba(166,175,195,0.35),inset_-2px_-2px_5px_rgba(255,255,255,0.9)] dark:shadow-[inset_2px_2px_6px_rgba(0,0,0,0.65)]">
                                        <div className="w-14 h-14 rounded-3xl bg-[#f0f3f8] dark:bg-[#191a24] border border-white/80 dark:border-[#2c2d3c] shadow-[4px_4px_12px_rgba(166,175,195,0.4),-4px_-4px_12px_rgba(255,255,255,0.95)] text-emerald-600 dark:text-emerald-400 flex items-center justify-center text-xl mb-2.5">
                                            <i className="fas fa-money-bill-trend-up"></i>
                                        </div>
                                        <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200">No Purchase Order Records</h3>
                                        <p className="text-xs text-slate-400 dark:text-slate-500 max-w-sm mt-1">
            ...
            title: 'Courier Partner Volume Breakdown & Dispatch Allocation',
                            ...
                            <div className="mt-4 relative h-70 w-full cursor-pointer">
                                ...
                                {!loading && !hasCourierData && (<div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 bg-[#ebf0f7] dark:bg-[#14151c] rounded-2xl border border-slate-200/60 dark:border-slate-800 shadow-[inset_2px_2px_5px_rgba(166,175,195,0.35),inset_-2px_-2px_5px_rgba(255,255,255,0.9)] dark:shadow-[inset_2px_2px_6px_rgba(0,0,0,0.65)]">
                                        <div className="w-14 h-14 rounded-3xl bg-[#f0f3f8] dark:bg-[#191a24] border border-white/80 dark:border-[#2c2d3c] shadow-[4px_4px_12px_rgba(166,175,195,0.4),-4px_-4px_12px_rgba(255,255,255,0.95)] text-pink-500 dark:text-pink-400 flex items-center justify-center text-xl mb-2.5">
                                            <i className="fas fa-chart-pie"></i>
                                        </div>
                                        <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200">No Courier Share Data</h3>
                                        <p className="text-xs text-slate-400 dark:text-slate-500 max-w-sm mt-1">
                ...
                {activeChartModal.isOpen && forecastData && (
                    <Portal>
                        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-slate-950/60 dark:bg-slate-950/70 backdrop-blur-md animate-in fade-in duration-200" onClick={(e) => {
                            if (e.target === e.currentTarget)
                                setActiveChartModal(prev => ({ ...prev, isOpen: false }));
                        }}>
                            <div className="bg-[#f0f3f8] dark:bg-[#191a24] rounded-3xl border border-white/80 dark:border-[#2c2d3c] shadow-[8px_8px_24px_rgba(166,175,195,0.4),-8px_-8px_24px_rgba(255,255,255,0.95)] dark:shadow-[10px_10px_30px_rgba(0,0,0,0.75)] max-w-3xl w-full max-h-[90vh] flex flex-col overflow-hidden" data-lenis-prevent>
                                {/* header */}
                                <div className="p-5 border-b border-slate-200/60 dark:border-slate-800/80 flex items-center justify-between shrink-0">
                                    <div className="flex items-center gap-3">
                                        <div className={`w-10 h-10 rounded-2xl flex items-center justify-center text-lg text-white shadow-xs ${activeChartModal.type === 'expense' ? 'bg-gradient-to-b from-emerald-500 to-emerald-600' : 'bg-gradient-to-b from-pink-500 to-pink-600'}`}>
                                    ...
                                    {activeChartModal.type === 'parcels' && (<>
                                            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                                                ...
                                                <div className="p-3.5 rounded-2xl bg-[#ebf0f7] dark:bg-[#14151c] border border-slate-200/60 dark:border-slate-800 shadow-[inset_1.5px_1.5px_3px_rgba(166,175,195,0.25)]">
                                                    ...
                                                    <div className="text-xs text-slate-500 dark:text-slate-400 mt-1 truncate font-medium" title={prevEval?.summary || ''}>
                                            ...
                                            <div>
                                                ...
                                                <div className="overflow-x-auto rounded-2xl border border-slate-200/60 dark:border-slate-800 bg-[#ebf0f7]/40 dark:bg-[#14151c]/40 shadow-[inset_1px_1px_3px_rgba(166,175,195,0.2)]">
                                                    <table className="w-full text-xs text-left">
                                                        ...
                                                        <tbody className="divide-y divide-slate-200/60 dark:divide-slate-800">
                                                            {forecastData.parcel_7_day.dates.map((dateStr, idx) => {
                                                                ...
                                                                return (<tr key={idx} className="hover:bg-white/60 dark:hover:bg-slate-800/40 transition">
