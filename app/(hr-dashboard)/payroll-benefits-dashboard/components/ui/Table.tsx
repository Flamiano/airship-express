...
>(({ className, ...props }, ref) => (
    <tfoot
        ref={ref}
        className={cn("bg-paper font-medium text-ink [&>tr]:last:border-b-0", className)}
        {...props}
    />
));
...
>(({ className, ...props }, ref) => (
    <tr
        ref={ref}
        className={cn(
            "border-b border-line transition-colors hover:bg-paper/50 data-[state=selected]:bg-paper",
            className
        )}
        {...props}
    />
