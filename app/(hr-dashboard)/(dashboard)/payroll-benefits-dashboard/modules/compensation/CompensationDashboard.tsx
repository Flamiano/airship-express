...
const CompensationDashboard = () => {
    const [activeTab, setActiveTab] = useState<'salary-structure' | 'employees' | 'benefits' | 'budget' | 'performance' | 'reports'>('salary-structure');
    ...
    return (
        <div className="space-y-5">
            ...
            <div className="flex items-center gap-1 border-b border-line dark:border-line/30 overflow-x-auto">
                {TABS.map((tab) => (
                    <button
                        ...
                        className={`flex items-center gap-1.5 border-b-2 px-3.5 py-2.5 text-sm font-medium font-rethink transition-colors whitespace-nowrap ${activeTab === tab.value
            ...
            {activeTab === 'employees' && <EmployeeCompensationManager />}
