...
export function CreateShiftModal({ open, onClose, onSubmit, drivers }: CreateShiftModalProps) {
 ...
 <form onSubmit={handleSubmit} className="space-y-3 text-xs">
      ...
      <div>
        <label className="font-medium text-xs text-muted block mb-1">Route / Shift Title</label>
        <input
          type="text"
          required
      ...
      <div>
        <label className="font-medium text-xs text-muted block mb-1">Assign Driver</label>
        <select
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          <label className="font-medium text-xs text-muted block mb-1">Time</label>
          <input
            type="text"
            required
