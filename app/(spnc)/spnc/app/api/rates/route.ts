...
export async function POST(req: NextRequest) {
  try {
    ...
    if (actor) await logAuditEvent({ ...actor, eventType: "user_activity", action: `${actor.actorName} created rate "${data.rate_code}"`, entityType: "rate", entityId: data.id, request: req });
